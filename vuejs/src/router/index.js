...
const Buy = () =>
  import(/* webpackChunkName: "Buy_Order" */ '../components/goods/Buy.vue')
...
const UserOrder = () =>
  import(
    /* webpackChunkName: "Order_Report" */ '../components/order/UserOrder.vue'
  )
...
const routes = [
  ...
  { path: '/login', component: Login },
  {
    ...
    children: [
      ...
      { path: '/orders/user', component: UserOrder }
    ]
  }
]
